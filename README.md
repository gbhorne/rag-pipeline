...
| Step | Phase 1 (Managed) | Phase 2 (Self-Built) |
|------|-------------------|---------------------|
| Chunk | Automatic (ChunkingConfig) | Custom Python function |
| Embed | text-embedding-004 (auto) | gemini-embedding-001 (explicit) |
| Store | Cloud Spanner (RagManagedDb) | ChromaDB (local) |
| Retrieve | rag.retrieval_query() | collection.query() |
| Generate | Tool.from_retrieval() | Custom prompt template |
